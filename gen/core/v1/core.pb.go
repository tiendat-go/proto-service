...
const file_core_v1_core_proto_rawDesc = "" +
	...
	"\vCoreService\x12A\n" +
	"\bSayHello\x12\x18.core.v1.SayHelloRequest\x1a\x19.core.v1.SayHelloResponse\"\x00Bf\n" +
	"\vcom.core.v1B\tCoreProtoP\x01Z\x0f/gen/go/core/v1\xa2\x02\x03CXX\xaa\x02\aCore.V1\xca\x02\aCore\\V1\xe2\x02\x13Core\\V1\\GPBMetadata\xea\x02\bCore::V1b\x06proto3"
...
var file_core_v1_core_proto_goTypes = []any{
	(*SayHelloRequest)(nil),  // 0: core.v1.SayHelloRequest
	(*SayHelloResponse)(nil), // 1: core.v1.SayHelloResponse
}
var file_core_v1_core_proto_depIdxs = []int32{
	0, // 0: core.v1.CoreService.SayHello:input_type -> core.v1.SayHelloRequest
	1, // 1: core.v1.CoreService.SayHello:output_type -> core.v1.SayHelloResponse
